...
createServer({
    ...
    routes() {
        ...
        this.post("/login", (schema, request) => {
            ...
            // This is an extremely naive version of authentication that is only being used to mock authentication
            // since this project is meant to focus on front-end skills
